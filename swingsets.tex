...
we avoid any mention of the technical story that for small oscillations a pendulum's period is $T\simeq 2\pi \sqrt{L/g}$.
...
Over the past few years, news organizations using ``open source intelligence techniques" have gained some notoriety.  One such organization, ``Bellingcat" (
...
among many investigations, gained prominence by revealing the method by which Russian opposition political Alexey Navalny was poisoned in 2020 \href{https://www.bellingcat.com/resources/2020/12/14/navalny-fsb-methodology/}{https://www.bellingcat.com/resources/2020/12/14/navalny-fsb-methodology/}. 
This organization uses ``open source" information to engage in investigative journalism and fact-checking.  
On their website, Bellingcat makes a large number of informational ``howto" articles available \href{https://www.bellingcat.com/category/resources/}{https://www.bellingcat.com/category/resources/}.

Along similar lines, the United States Government Defense Mapping Agency published an unclassified Student Handbook on Photo Interpretation Principles \cite{USDMA_book}.  A 1996 copy of this handbook is available in many places online.  This book, written for novice cartographers, illustrates many ways to infer measurements based on aerial and satellite photographs.  This is a useful reference, given the abundance of information that Google Maps and similar sites make available.

Both of these resources use information that is freely available to anyone with an internet connection to investigate and test claims.  In the Physics classroom, this seems like an exciting, modern, and relevant place to make a connection to ``checking our answer" with techniques similar to those use to establish that chemical weapons were being used in the Syrian Civil war \cite{bellingcat_syria}.

So at the end of this lab, I ask students to use some other way of knowing to check their answer for the height of the Moab arch or the pedestrian bridge in Sault St. Marie.  Here are a few of the conversations and student efforts that have resulted.
...
Many students have done a google search for "height of Sault St. Marie bridge'' or similar.  Google seems to interpret this as the height of the "International" road bridge across the Soo locks 
...
, whch is reported to be 124 feet (38m) in height.  This is obviously not the correct bridge in the video.
\begin{figure}[h]
\centering
	\includegraphics[width=\columnwidth]{Google_International_Soo_bridge.png}
\caption{
Google results for ``height of Sault St. Marie bridge" are obviously incorrect for the pedestrian/bicycle bridge in question.
	}
	\label{Google_Soo}
\end{figure}

Along similar lines, I'm embarrased to admit that some of my students have asked the video creator the bridge's height.
\begin{figure}[h]
\centering
...
\subsection{shadows}
There are many shadows cast in the overhead photos of Sault St. Marie.  We can use some to estimate, by scaling, the height of the bridge to be:
